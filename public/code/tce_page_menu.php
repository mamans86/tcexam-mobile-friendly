...
$menu = array(
    'index.php' => array('link' => 'index.php', 'title' => $l['h_index'], 'name' => '<span class="icon-home2"></span> '.$l['w_index'], 'level' => K_AUTH_PUBLIC_INDEX, 'key' => 'i', 'enabled' => true),
    'tmf_chat.php' => array('link' => 'tmf_chat.php', 'title' => 'Chat', 'name' => '<span class="icon-bubble"></span> Chat', 'level' => K_AUTH_PAGE_USER, 'key' => 'c', 'enabled' => K_CHAT_FEATURE),
    ...
    'tce_page_user.php' => array('link' => 'tce_page_user.php', 'title' => $l['w_user'], 'name' => '<span class="icon-users"></span> '.$l['w_user'], 'level' => K_AUTH_PAGE_USER, 'key' => 'u', 'enabled' => ($_SESSION['session_user_level'] > 0)),
...
$menu['tce_page_user.php']['sub'] = array(
    'tce_user_change_email.php' => array('link' => 'tce_user_change_email.php', 'title' => $l['t_user_change_email'], 'name' => '<span class="icon-envelop"></span> '.$l['w_change_email'], 'level' => K_AUTH_USER_CHANGE_EMAIL, 'key' => '', 'enabled' => true),
