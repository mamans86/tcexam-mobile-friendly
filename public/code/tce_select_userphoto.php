...
if (isset($_POST['rename'])) {
    ...
    $menu_mode = 'delete';
}elseif (isset($_POST['hapuspaksa'])) {
    $menu_mode = 'hapuspaksa';
}
...
switch ($menu_mode) {
    case 'delete':{
        ...
        F_submit_button('hapuspaksa', $l['w_delete'], $l['h_delete']);
...
if (!empty($file)) {
   ...
   //FJ_insert_text(window.opener.document.getElementById('form_questioneditor').question_description, '[object]'+document.getElementById('tcefile').value+'[/object:'+document.getElementById('object_width').value+':'+document.getElementById('object_height').value+':'+document.getElementById('object_alt').value+']');self.close();
   
   
    //$onclick = 'FJ_insert_text(window.opener.document.getElementById(\''.$callingform.'\').'.$callingfield.', \'[object]\'+document.getElementById(\'tcefile\').value+\'[/object:\'+document.getElementById(\'object_width\').value+\':\'+document.getElementById(\'object_height\').value+\':\'+document.getElementById(\'object_alt\').value+\']\');';
	
	//$onclick = 'FJ_insert_text(window.opener.document.getElementById(\''.$callingform.'\').'.$callingfield.', \'[img]'.K_PATH_HOST.K_PATH_URL_CACHE.'\'+document.getElementById(\'tcefile\').value+\'[/img]\');';
	$onclick = 'FJ_insert_text(window.opener.document.getElementById(\''.$callingform.'\').'.$callingfield.', \'[img]'.K_PATH_HOST.K_PATH_URL_CACHE.'\'+document.getElementById(\'tcefile\').value+\'[/img]\');';
	
	//$onclick = 'FJ_insert_text(window.opener.document.getElementById(\''.$callingform.'\').'.$callingfield.', \'[img width=&quot;\'+document.getElementById(\'object_width\').value+\'&quot; height=&quot;\'+document.getElementById(\'object_height\').value+\'&quot; alt=&quot;\'+document.getElementById(\'object_alt\').value+\'&quot; title=&quot;\'+document.getElementById(\'object_alt\').value+\'&quot;]'.K_PATH_HOST.K_PATH_URL_CACHE.'\'+document.getElementById(\'tcefile\').value+\'[/img]\');';
