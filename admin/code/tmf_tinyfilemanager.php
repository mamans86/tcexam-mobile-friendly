...
// Generate secure password hash - http://pemdas.yayasan-gondang.com/pwd.php
$auth_users = array(
    'admin' => K_ADMIN_FILE_BROWSER_PWD //admin@123
...
$root_path = K_PATH_CACHE;

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
$root_url = K_PATH_URL_CACHE;
...
function fm_get_translations($tr) {
    try {
        $content = @file_get_contents('tmf_translation.json');
        if($content !== FALSE) {
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Tiny File Browser';      $tr['en']['AppTitle']           = 'File Browser';
