This report no longer maintained, please go to our newer project called TMFAJAX ( TCExam Mobile Friendly with AJAX Support ). You can visit the report here https://github.com/Xamzone/tmfajax
